...
addSignal('POSE_DEBUG', msg.utime, msg.rotation_rate[0])
addSignal('POSE_BODY', msg.utime, msg.rotation_rate[0])

addPlot()
addSignal('POSE_DEBUG', msg.utime, msg.rotation_rate[1])
addSignal('POSE_BODY', msg.utime, msg.rotation_rate[1])


addPlot()
addSignal('POSE_DEBUG', msg.utime, msg.rotation_rate[2])
